...
execute_process(
	COMMAND "${CMAKE_COMMAND}" --build "${WT_COPY_TARGET_TEST_BINARY_DIR}" --config Release --target consumer
...
execute_process(
	COMMAND "${CMAKE_COMMAND}" --build "${WT_COPY_TARGET_TEST_BINARY_DIR}" --config Release --target consumer_deploy
